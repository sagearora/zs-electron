...
function SettingsScreen() {
    ...
    return <div className='my-6 max-w-screen-md mx-auto container'>
        ...
        <Link className='flex items-center hover:bg-slate-100 p-2 border-b-2' to='templates'>
            <p className='text-sm flex-1'>
                Manage Steri Templates
            </p>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
            </svg>
        </Link>
        <Link className='flex items-center hover:bg-slate-100 p-2 border-b-2' to='counts'>
            <p className='text-sm flex-1'>
